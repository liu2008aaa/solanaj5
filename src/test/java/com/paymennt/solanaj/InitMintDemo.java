...
public class InitMintDemo {
    public static void main(String[] args) {
        ...
        //tx for init mint
        SolanaTransaction tx = TokenProgram.createMintTx(payer,mint,mintAuthority,freezeAuthority,space,lamports,tokenDecimal,lastBloackHash);
        //send tx
